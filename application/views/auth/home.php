...
<section id="hero">
    ...
    <a href="<?= base_url("auth"); ?>"><button class="btn btn-success">Shop Now</button></a>
</section>
...
<section id="banner" class="section-m1">
    ...
    <a href="<?= base_url("home/about"); ?>"><button class="normal">Selengkapnya Klik Disini!!!</button></a>
</section>
    ...
    <div class="pro-container">
        <?php foreach ($barang2 as $brg2) : ?>
            <div class="pro">
                ...
                <?= anchor('home/detail_produk/' . $brg2->id_barang, '<i class="fas fa-shopping-cart"></i>'); ?>
            </div>
        <?php endforeach; ?>
    </div>
</section>
...
<section id="sm-banner" class="section-p1">
    <div class="banner-box">
        ...
        <a href="<?= base_url("home/about"); ?>"><button class="white">Learn More</button></a>
    </div>
