...
class Home extends CI_Controller
{
    ...
    public function hoodie()
    {
        //load library
        $this->load->library('pagination');
        $config['base_url']     = 'http://localhost/dalboonline/home/hoodie';
        ...
        $data['title'] = 'Hoodie';
        $this->load->view('user/templates/header', $data);
        $this->load->view('auth/produkhoodie', $databarang);
        $this->load->view('user/templates/footer');
    }
    ...
    public function crewneck()
    {
        //load library
        $this->load->library('pagination');
        $config['base_url']     = 'http://localhost/dalboonline/home/crewneck';
        $config['total_rows']   = $this->m_daerah->countHoodie();
        $config['per_page'] = 8;
        ...
        $data['title'] = 'Hoodie';
        $this->load->view('user/templates/header', $data);
        $this->load->view('auth/produkcrewneck', $databarang);
        $this->load->view('user/templates/footer');
    }
    ...
    public function search()
    {
        //load library
        $this->load->library('pagination');
        $config['base_url']     = 'http://localhost/dalboonline/home/search';
        $config['total_rows']   = $this->m_daerah->countHoodie();
        $config['per_page'] = 8;
